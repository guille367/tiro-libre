angular.module('ui.rCalendar', [])
    .constant('calendarConfig', {
        ...
        queryMode: 'local',
        step: 60,
        monthviewDisplayEventTemplateUrl: 'client//templates/rcalendar/monthviewDisplayEvent.html',
        monthviewEventDetailTemplateUrl: 'client//templates/rcalendar/monthviewEventDetail.html',
        weekviewAllDayEventTemplateUrl: 'client//templates/rcalendar/displayEvent.html',
        weekviewNormalEventTemplateUrl: 'client//templates/rcalendar/displayEvent.html',
    ...
    .directive('calendar', function () {
        ...
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'client/templates/rcalendar/calendar.html',
            scope: {
                calendarMode: '=',
                rangeChanged: '&',
                eventSelected: '&',
    ...
    .directive('monthview', ['dateFilter', function (dateFilter) {
        ...
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'client//templates/rcalendar/month.html',
            require: ['^calendar', '?^ngModel'],
            link: function (scope, element, attrs, ctrls) {
                var ctrl = ctrls[0],
                    ngModelCtrl = ctrls[1];
    ...
    .directive('weekview', ['dateFilter', function (dateFilter) {
        ...
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'client//templates/rcalendar/week.html',
            require: '^calendar',
    ...
    .directive('dayview', ['dateFilter', function (dateFilter) {
        ...
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'client/templates/rcalendar/day.html',
            require: '^calendar',
            link: function (scope, element, attrs, ctrl) {
                scope.formatHourColumn = ctrl.formatHourColumn;
